...
public abstract class Algorithm {
    ...
    /**
     * Returns the single solution if there exists only one
     */
    ...
    /**
     * Sets the given solution to the solution of this class
     */
    public void setSolution(int solution) {
        this.solution = solution;
    }

    protected final void setSolutionString(String s) {
        this.solutionString = s;
    }

    protected final String getSolutionString() {
        return this.solutionString;
    }

    public final int[] getSolutionIndexes() {
        return this.solutionIndexes;
    }
